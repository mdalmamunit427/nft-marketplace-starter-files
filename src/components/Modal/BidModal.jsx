...
const BidModal = ({isOpen, onClose, onBidSubmit, fullName, setFullName, email, setEmail, bidAmount, setBidAmount}) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
        <div className='p-5'>
            <h1 className='capitalize text-2xl font-bold mb-4 text-gray-500'>Place your bit</h1>
            <form onSubmit={handleBidSubmit}>
                ...
                <input type="email" placeholder='Your email' value={email}  onChange={(e) => setEmail(e.target.value)} className='border p-2 mb-4 w-full text-gray-500' required/>
